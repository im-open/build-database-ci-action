...
| `test-timeout`                   | **No**                                                                                     | 0     | An optional setting for the allowed wait time, in seconds, for the tests to execute. If tests sometimes hang, or shouldn't take longer than a certain amount of time, this parameter can be helpful. The default of 0 means no timeout.                                                                                                                               |
  ...
  build-database:
    ...
    steps:
      ...
      - name: Build Database
        ...
        uses: im-open/build-database-ci-action@v3.3.2
        with:
